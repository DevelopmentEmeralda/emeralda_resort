        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 pl-0">
                <div class="intro-content ">
                    ...
                    <h3 class="">Diisi Tagline Produk / Perusahaan</h3>
                    <p class=""><?php echo lang_check('categories_presentation_description');?></p>
                    <p class="">Diisi Dengan Deskripsi Dari Produk / Perusahaan</p>
                    <!--< ?php echo $href_btn;?>-->
					<a href='<?php echo $href_btn;?>' class="btn btn-outline-primary view-btn">
                        ...
                        <i class="icon-arrow-right-circle"></i>Booking Sekarang</a>
