              ...
              <div class="widget widget-theme-color wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <hr />
                    <!-- Form starts.  -->
                    <?php echo form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form'))?>                                <?php
                                    $idprop = $enquire->property_id;
                                    $idagent = $enquire->agent_id;
                                    $namaagent = $enquire->agent_id;
                                    $customer = $enquire->name_surname;
                                    $nohp = $enquire->phone;
                                    $email = $enquire->mail;
                                    $pesan = $enquire->message;
                                    $alamat = $enquire->address;
                                  ...
                                  <table>
                                    <tr>
                                        <?php
                                            ...
                                            $linknya = "https://yplproduction.emeraldaresortofficial.com/admin/send_email/kirim_email?agent=$idagent&nama=$customer&nohp=$nohp&email=$email.com&alamat=$alamat&pesan=$pesan&jenis=$idprop";
                                            
                                            // echo $linknya;
                                        ?>
                                        
        
                                      <td><a href="<?php echo $linknya ?> "class="btn btn-default"><?php echo lang('Reply to email')?></a></td>
                                      <td><?php if(isset($enquire->mail)):?><a href="mailto:<?php echo $enquire->mail?>?subject=<?php echo lang('Reply on question for real estate')?>: <?php echo isset($enquire->p_address); ?>&amp;body=<?php echo $enquire->message?>" class="btn btn-default">Follow Up To Sales</a><?php endif;?></td>
                                      
                                      <td width=100%>&nbsp;</td>
                                      <td><a href="<?php echo site_url('admin/enquire')?>" class="btn btn-primary themebtn invert" type="button"><?php echo lang('Cancel')?></a></td>
                                      <td><?php echo form_submit('submit', lang('Save'), 'class="btn btn-success themebtn"')?></td>
