...
class User_m extends MY_Model {
    ...
    public function get_agentuser($userid)
    {
        ...
        {
           $row = $query->row_array();
           return $this->get_array($row['id']);
        }
        
        return array();
    }
    
    public function get_propertylist($id)
    {
        // $this->db->select('*');
        ...
        $myQuery = "SELECT id,CAST(value AS CHAR) AS nama FROM property_value WHERE  property_id = {$id} AND option_id=10 ";
